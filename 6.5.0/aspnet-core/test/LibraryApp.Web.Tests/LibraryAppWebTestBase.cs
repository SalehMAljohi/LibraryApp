...
namespace LibraryApp.Web.Tests
{
    public abstract class LibraryAppWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static LibraryAppWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(LibraryAppWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<LibraryAppDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<LibraryAppDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<LibraryAppDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<LibraryAppDbContext, Task<T>> func)
        {
            T result;
